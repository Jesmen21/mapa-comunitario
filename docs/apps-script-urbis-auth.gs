 ...
 * V162: Social URBIS con ID privado de 8 caracteres, búsqueda de amigos y solicitudes.
 */
...
function doGet(e) {
  ...
  return json_({ ok: true, message: 'URBIS Auth activo.', version: 'urbis-auth-v226' });
}
